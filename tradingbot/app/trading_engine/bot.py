...
try:
    ...
    # python-binance >= 1.0.x removed ORDER_TYPE_STOP_MARKET from enums;
    # define it as the raw string value the Binance Futures API expects.
...
try:
    # Relative import when loaded as part of the app.trading_engine package
